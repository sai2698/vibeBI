...
# Find the section to replace - from "# Build FROM and JOIN" to the return statement
# We need to replace the entire multi-table join logic

# Pattern to find the old join logic
old_pattern = r'''    # Build FROM and JOIN
    if not is_multi:
...
if re.search(pattern, content, re.DOTALL):
    ...
    print("Searching for 'Build FROM and JOIN'...")
    if "# Build FROM and JOIN" in content:
        print("Found the comment but pattern didn't match.")
